...
## Deployment
* The site is currently deployed to [https://sparkgeo.github.io/uk_eodatahub/] but this may change.
* The source is the docs section of our [uk_eodatahub] repo on GitHub.
* This page specifically is [here](https://github.com/sparkgeo/uk_eodatahub/edit/main/docs/reference/documentation/x1-appendix-a.md)
  
  [https://sparkgeo.github.io/uk_eodatahub/]: https://sparkgeo.github.io/uk_eodatahub/
  [uk_eodatahub]: https://github.com/sparkgeo/uk_eodatahub/edit/main/docs/
  
It takes a couple of minutes for updates to be deployed.  You can check the status of the update in the [actions](https://github.com/sparkgeo/uk_eodatahub/actions) page in the repo.
...
### Fonts and headings
Basics include *italics*, **bold** and headings such as 
### Level 3 heading
#### Level 4 heading 
##### Level 5 heading
etc
...
>
> It **can also include formatting** such as **bold**, *italics*, ***both*** and
> * lists
> * like this one
> 
...
*But* this is the next text after the break and it isn't so not sure how that can be controlled.
...
So this is the [owls page](/uk_eodatahub/owls/) [this](/uk_eodatahub) would be the index page, and the [beetles page](/uk_eodatahub/insects/beetles) although these pages are no longer in the repo!
    
    So this is the [owls page](/uk_eodatahub/owls/)  
    [this](/uk_eodatahub) would be the index page, and the 
    [beetles page](/uk_eodatahub/insects/beetles).

This [Appendix page][AP] is done as a reference link.
[AP]: /uk_eodatahub/xxx-questions.md

### Images
Here is an image.

![Hazard indicator alt text](/uk_eodatahub/user%20guide/images/hazards/1.png "Hazard indicator title")
...
### Ordering pages
* It seems to be _alphabetical_ by the name of the file in the repo.  The title of the file can be entirely different to its name, and the title is what is rendered.  So I've now prefixed this filename with ***xxx*** so that it appears at the end of the index list.  So a file named ***aaa-introduction*** with a _title_ of _Introduction_ would be first in the list.
